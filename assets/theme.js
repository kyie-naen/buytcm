...
function copyToClipboard() {
    const text = document.getElementById("tcmCode").innerText; // Ambil teks dari <h3>
    const copyTxt = 'buytcm.com/?tags='+text;
...
//         const newBox = html.querySelector('.list-cart-items').innerHTML;

//         // Pastikan elemen target ada di halaman sebelum memperbarui
//         const listCartItems = document.querySelector('.list-cart-items');
//         if (listCartItems) {
//             // listCartItems.innerHTML = newBox;  
//             console.log(newBox);
//             console.log("Cart page updated successfully.");
//         } else {
//             console.error("Target element '.list-cart-items' not found in the document.");
//         }
//     } catch (error) {
//         console.error("Error fetching or updating cart page:", error);
//     }
// }
